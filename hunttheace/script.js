...
const cardObjectDefinitions = [
    {id:1, imagePath:'images/card-king.png'},
    {id:2, imagePath:'images/card-jack.png'},
    {id:3, imagePath:'images/card-queen.png'},
    {id:4, imagePath:'images/card-ace.png'}
]
const aceId = 4

const cardBackImgPath = 'images/backcard.png'
...
<div class="card-inner">
    <div class="card-front">
        <img src="images/card-jack.png" alt="" class="card-img">
    </div>
    <div class="card-back">
...
function gameOver()
{
    ...
    const gameOverMessage = `Game Over! Final Score - <span class = 'badge'>${score}</span> Click 'Play' button to play again`
